...
* {\em Code generator}. Translating from middle end to back end IR is often
...
The transition from values is not as straightforward
as it may seem. 
...
(`operand_cnt` is 0). Absence of a return value could also be represented with a
