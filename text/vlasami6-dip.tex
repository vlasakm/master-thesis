...
The registers are illustrated in figure~\ref[TODO]. The full registers (like
...
so this can be captured by a pattern which \"retypes" the node TODO figure.
...
would be multi-output. TODO figure
...
system (for example with a call to the `exit` function of standard C). As
