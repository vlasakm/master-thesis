...
other one has to be either a register or an immediate value. So we still have to
solve the problem of having to use {\em registers} for storing/retrieving
spilled values.
...
Live range vs value vs variable.
